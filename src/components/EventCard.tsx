...
import { MapPin, Clock, Users, Calendar, ChevronDown, ChevronUp } from "lucide-react";
...
export default function EventCard({ 
  ...
  return (
    ...
    >
      <div className={`p-4 ${event.isBreak ? "" : "cursor-pointer touch-feedback"}`}>
        <div className="flex items-start gap-3">
            ...
            <div className="flex items-center gap-3 text-xs text-white/50 flex-wrap">
              ...
              {!event.isBreak && (
                <a
                  ...
                  className="flex items-center gap-1 text-dawn-teal hover:text-dawn-light transition-colors"
          ...
          <div className="flex flex-col items-end gap-2 flex-shrink-0">
            ...
            {!event.isBreak && (
              <div className="text-white/30" onClick={handleCardClick}>
                {isExpanded ? (
          ...
          <div className="border-t border-white/10 pt-4 mt-1">
            ...
            <div className="flex gap-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-lg bg-gradient-to-r from-dawn-teal/30 to-dawn-light/20 text-dawn-teal text-sm font-medium touch-feedback border border-dawn-teal/30"
              >
