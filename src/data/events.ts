...
// Main Conference Events - CORRECTED TIMES based on actual schedule
...
const MAIN_CONFERENCE_EVENTS: Event[] = [
  ...
  },
  {
    ...
    description: "Introduction to the afternoon session.",
    pricing: { premiumAttendee: 0, standardAttendee: 0, nonAttendee: 0 },
    tags: ["intro"],
    emoji: "🎙️",
  },
  ...
  {
    id: "mc-7",
    title: "Inside the exit: Two founders on building, scaling, and selling digital businesses",
    type: "main_conference",
    track: "SCALE UP",
    date: "2026-01-18",
    startTime: "10:30",
  ...
  },
  {
    ...
    speakers: [
      ...
      { name: "Christoph Huebner", role: "Panelist" },
    ],
